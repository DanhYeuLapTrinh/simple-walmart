<%-- 
    Document   : shopping
    Created on : Jun 25, 2023, 8:11:02 PM
    Author     : admin
--%>
            ...
            <div class="box">
                <form action="Middle_Servlet" method="POST">
                    <div class="search-section">
                        ...
                        <div class="txtField">
                            <input type="text" name="txtSearchValueShopping" value="${param.txtSearchValueShopping}" placeholder="What do you want?"/>
                            <span class="icon">
                ...
                <div class="result-section">
                    <div class="table-section">
                        <c:set var="searchVal" value="${param.txtSearchValueShopping}"/>
                        <c:if test="${not empty searchVal}">
                            <c:set var="result" value="${requestScope.SHOPPING_SEARCH_RESULT}"/>
                            <c:if test="${not empty result}">
                                ...
                                <c:if test="${empty result}">
                                    <div class="blank">
                                        ...
                                        <p>We couldn't find the result for "${searchVal}"</p>
                        ...
                        <input type="hidden" name="searchHistory" value="${searchVal}"/>
                        </form>
                    </c:if>
                </div>
            </div>
